...
1000 REM **** A JULIA SET ****
1005 REM AJY 2013-03-03 ANTTI J. YLIKOSKI
1010 REM DEMONSTRATION OF COMPLEX ARITHMETIC
1012 REM THIS JULIA SET IS AN UNCOUNTABLY INFINITE SET
...
1022 REM -- AFTER THE FRENCH MATHEMATICIAN GASTON JULIA
1025 DEFDBL A-Z: REM ALL VARIABLES ARE DOUBLE PRECISION
1030 READ LAMBDAX, LAMBDAY, SCALE, UMIN, UMAX, VMIN, VMAX
1040 REM DATA 3.2, 0.0, 1.0, -0.1, 1.1, -0.5, 0.5
1050 DATA 3.0,0.5,1.0,-0.1,1.1,-0.5,0.5
1052 LET XORIGO = 60!
1054 LET YORIGO = 180!
...
1110 CLS
1120 SCREEN 9
1130 PRINT "A FRACTAL JULIA SET IN THE COMPLEX PLANE"
...
1187 FOR I = 1 TO 1000000
    1190 GOSUB 5000: REM CALCULATE Z = F(Z)
    1192 LET XPIX = XORIGO + 500! * X
    1194 LET YPIX = YORIGO - 500! * Y
    1200 GOSUB 7000: REM DRAW THE RESULTING COMPLEX POINT ON SCREEN
1210 NEXT I
1220 END
...
7020 LINE (XPIX, YPIX)-(XPIX, YPIX), 10, B
_DISPLAY
7030 RETURN
9999 END
